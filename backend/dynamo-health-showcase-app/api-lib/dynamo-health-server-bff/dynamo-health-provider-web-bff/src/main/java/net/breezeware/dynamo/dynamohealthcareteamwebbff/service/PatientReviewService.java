package net.breezeware.dynamo.dynamohealthcareteamwebbff.service;

import static net.breezeware.dynamo.dynamointakeformsvc.enumeration.IntakeFormStatus.COMPLETED;
import static net.breezeware.dynamo.dynamointakeformsvc.enumeration.IntakeFormStatus.PHYSICIAN_REVIEWED;
import static net.breezeware.dynamo.dynamointakeformsvc.enumeration.IntakeFormStatus.PHYSICIAN_REVIEW_NEEDED;
import static net.breezeware.dynamo.dynamointakeformsvc.enumeration.IntakeFormStatus.REVIEW_PENDING;
...
import net.breezeware.dynamo.dynamointakeformsvc.entity.QIntakeForm;
import net.breezeware.dynamo.dynamointakeformsvc.enumeration.IntakeFormStatus;
import net.breezeware.dynamo.dynamointakeformsvc.service.IntakeFormService;
import net.breezeware.dynamo.dynamoworkflowsvc.processmanagement.healthshowcaseprocess.service.DynamoHealthShowcaseProcessService;
