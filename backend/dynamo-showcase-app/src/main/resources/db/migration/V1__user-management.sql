...
VALUES
    (1, 'us-east-1_u1phSSzqL', 'cognito', 'Amazon Cognito is a fully managed identity verification and user management service', NOW(), NOW());
...
VALUES
    (1, 'admin', 'The "admin" role provides administrative privileges and access to system settings and features.', NOW(), NOW()),
    (2, 'user', 'The "user" role is for standard users who have access to basic functionality and features of the system.', NOW(), NOW());

--Add Group
   INSERT INTO dynamo."group" (id, name, description, created_on, modified_on)
VALUES
(1, 'administrative', 'The "Administrative" group is for administrative staff with access to system management functions.', NOW(), NOW()),
    (2, 'development', 'The "Development" group is for software development teams.', NOW(), NOW());
...
VALUES
    (1, '4c2bb19c-854d-4320-b257-bae33e1fe279', '0138e238-6684-47c2-a46e-1f92be8514d2', 1, 'Siddharth', 'Elancheziyan', 'siddharth@breezeware.net', '+919578199005', 'active', NOW(), NOW());

-- Add User Organization Map
   INSERT INTO dynamo.user_organization_map (id, user_id, organization_id, created_on, modified_on)
VALUES
    (1, '4c2bb19c-854d-4320-b257-bae33e1fe279', 1, NOW(), NOW());
